...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Vector X Hub สวัสดีทุกคน<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Vector X Hub", HidePremium = false, IntroText = "️Vector X Hub", SaveConfig = true, ConfigFolder = "Vector X Hub"})
...
W:AddLabel("ผู้พัฒนา")
W:AddLabel("Vector X Hub SCRIPT")
W:AddLabel("Discord Vector X Hub")
local Section = W:AddSection({
    Name = "Status"
})
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : (ในอนาคต)")
...
M:AddToggle({
    Name = "Kaitun[ไม่มีการโจมตีผู้เล่น]",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Vector X Hub(Noitification)",
                ...
                OrionLib:MakeNotification({
                    Name = "Vector X Hub(Noitification)",
                    Content = "[TH]กรุณายกเลิกภารกิจฟาร์มเลเวล(ถ้ามี)",
                    Image = "rbxassetid://8192162908",
                    Time = 9
                })
            end
